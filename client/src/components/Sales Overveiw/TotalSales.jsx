    ...
    <>
        <div className="flex flex-wrap gap-14 font-outfit border p-5 rounded-xl hover:translate-y-[-2px] duration-300 ease-in-out cursor-pointer">
            <div className="flex flex-wrap gap-4">
                ...
                <span className='text-[#1E40AF]'><MdOutlineInsertChartOutlined fontSize={23}/></span>
                </div>
                </div>
                <div className="">
                    <p className='text-[16px]'>Total Sales</p>
                    <h1 className='flex flex-wrap items-end gap-1'><span className='text-[#6B7280] text-sm'>$</span><h2 className=' font-medium text-2xl'>41,308</h2></h1>
                </div>
            </div>
