                ...
                <div className="flex flex-col gap-2">
                    <div className="flex items-center justify-between bg-[#f0f0f0] p-3 rounded-xl">
                        <div className="flex items-center gap-3">
                            <div className="bg-[#ff5959] p-3 rounded-full">
                                <span className='text-white '><MdOutlineShoppingBag fontSize={20}/></span>
                            </div>
                            <div className="">
                                <div className="flex items-center gap-3">
                                ...
                                <span>Exciting news! Customer John Doe just made a purchase. Order #12345 has been successfully placed</span>
                            </div>
                        </div>
                        <div className="">
                            <span className='text-[#ff5959]'><FaCircleDot/></span>
                        </div>
                    </div>
