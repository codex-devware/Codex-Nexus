    ...
    <>
        <div className="overflow-x-auto font-outfit">
                ...
                <thead
                    ...
                    <tr>
                    <th scope="col" className="pl-6 pr-4 py-2.5">Name</th>
                    <th scope="col" className="pr-3 py-2.5">Register Date</th>
                    <th scope="col" className="px-6 py-2.5">Email</th>
                    <th scope="col" className="px-6 py-2.5">Account Type</th>
                    <th scope="col" className="px-6 py-2.5">Last Active</th>
                 ...
                 <tbody>
                  {data.map((item) => (
                    <tr key={item.id} className="border-b border-dashed">
                      ...
                      <td className="whitespace-nowrap px-7 py-4 font-medium">{item.role}</td>
                      <td className="whitespace-nowrap px-7 py-4">
                        {item.lastActive}
                      </td>
                      <td className="whitespace-nowrap px-6 py-4">
                        <button className='bg-[#F7E4DA] rounded-lg py-2 px-5 font-semibold text-[#D77748]'>{item.status}</button>
                      </td>
                      <td className="whitespace-nowrap px-6 py-4">
                        <UserAction/>
                      </td>
