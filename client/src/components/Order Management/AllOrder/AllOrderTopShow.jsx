...
const AllOrderTopShow = ({ data }) => {
  ...
  return (
    <div className="flex flex-wrap gap-20 justify-between  shadow font-outfit border p-5 rounded-xl hover:translate-y-[-2px] duration-300 ease-in-out cursor-pointer">
