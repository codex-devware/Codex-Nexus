...
const RevenueAnalyticsStatShow = ({ data }) => {
  ...
  return (
    <div className="shadow font-outfit flex flex-col gap-2 border p-4 w-[300px] sm:w-full mx-auto rounded-xl hover:translate-y-[-2px] duration-300 ease-in-out cursor-pointer bg-white">
      <div className="">
      ...
      <div className="flex justify-between">
        <h1
          className={`${
            profit ? "text-highlight" : "text-primary"
