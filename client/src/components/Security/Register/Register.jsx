            ...
            <form className="px-8 pt-6 pb-8 mb-4 font-outfit  rounded">
              <div className="mb-4 md:flex md:justify-between">
                <div className="mb-4 md:mr-2 md:mb-0 ">
                  ...
                  <input
                    className="w-full px-3 py-2 text-sm leading-tight dark:text-[#F4F7F9] text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    id="firstName"
                    type="text"
                ...
                <div className="md:ml-2">
                  ...
                  <input
                    className="w-full px-3 py-2 text-sm dark:text-[#F4F7F9] leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                    id="lastName"
                    type="text"
              ...
              <div className="mb-4">
                ...
                <input
                  className="w-full px-3 py-2 mb-3 dark:text-[#F4F7F9] text-sm leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline"
                  id="email"
                  type="email"
                  placeholder="Email"
                />
