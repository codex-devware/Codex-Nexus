...
const MailBox = () => {
  ...
  let headerActionBtn =
    "px-6 py-2 bg-[#dce5ff] ml-3 flex justify-between rounded-sm font-medium text-sm";
    ...
    <div>
      ...
      <div className="lg:flex lg:flex-wrap sm:block sm:text-center justify-between items-center mt-8">
        ...
        <div className="action-head flex flex-wrap justify-center md:justify-between">
          ...
          {!menuState && (
            <div
              className="lg:hidden w-[20px] h-[20px] md:ml-[170px] mb-4"
      ...
      <div className="flex flex-wrap justify-between mt-6">
        ...
        <div
          className={`w-3/12 sm:ml-[-1000px] ${classAdded} bg-white h-auto px-4 py-5 `}
        >
          ...
          <div>
            <div className={`bg-[#daeaff] ${mailAction}`}>
              {" "}
              <IcMail /> Inbox{" "}
              <label className="w-[25px] h-[25px] rounded-full bg-[#cdf] overflow-hidden text-center xl:ml-[60%] lg:ml-[60%] sm:ml-[35%] sm:text-[14px] ml-[75%]">
                3
              </label>
            </div>
            ...
            <div className={mailAction}>
              <IcDraft /> Drafts{" "}
              <label className="w-[25px] h-[25px] rounded-full bg-[#cdf] overflow-hidden text-center xl:ml-[60%] lg:ml-[48%]  lg:text-[15px] sm:ml-[35%] sm:text-[14px] ml-[75%]">
                12
              </label>
            </div>
            <div className={mailAction}>
        ...
        <div className="w-[70%] sm:w-full h-[600px] bg-white"></div>
      </div>
    </div>
  );
};
