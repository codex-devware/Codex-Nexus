const ManagementFooter = ({
  ...
  return (
    ...
    >
      {/* Pagination info */}
      <span className="text-sm font-normal text-gray-500 border-2 ms-4 border-gray-300 px-2 py-2 rounded-md">
        Showing
      ...
      <ul className="inline-flex items-stretch -space-x-px gap-2 rounded-md">
        ...
        <li>
          <button
            ...
            className="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 me-4"
          >
