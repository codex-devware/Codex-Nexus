            ...
            <ul className="hidden lg:flex m-2 gap-6 items-center">
              ...
              <li>
                <div className="dropdown dropdown-hover">
                  ...
                  >
                    <li>
                      <h2 className=" text-[16px] font-bold bg-transparent border-none shadow-none hover:bg-transparent ">
                        {" "}
                        Md Kawsar
                      </h2>
                      <h4 className="text-xs bg-transparent border-none shadow-none hover:bg-transparent -mt-4">
                        Web Designer
                      </h4>
                    </li>
                    <li>
