            ...
            <div className=" relative  overflow-hidden">
                    ...
                    <div className="w-full md:w-1/2">
                        <form className="flex items-center">
                            ...
                            <div className="relative w-full">
                                ...
                                <input type="text" id="simple-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#3b82f6] outline-[#3b82f6] focus:border-[#3b82f6] block w-full pl-10 p-2 " placeholder="Search" required=""/>
                            </div>
                        </form>
                    </div>
                    <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        <button type="button" className="flex items-center justify-center text-white bg-[#1d4ed8] hover:bg-[#1e40af] focus:ring-4 focus:ring-[#93c5fd] font-medium rounded-lg text-sm px-4 py-2 focus:outline-none">
                        ...
                        <div className="flex items-center space-x-3 w-full md:w-auto">
                            <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown" className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-[#1d4ed8] focus:z-10 focus:ring-4 focus:ring-gray-200" type="button">
                            ...
                            <div id="filterDropdown" className="z-10 hidden w-48 p-3 bg-white rounded-lg shadow">
                                ...
                                <ul className="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                                    <li className="flex items-center">
                                        <input id="apple" type="checkbox" value="" className="w-4 h-4 bg-gray-100 border-gray-300 rounded text-[#2563eb] focus:ring-[#3b82f6]  focus:ring-2"/>
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left text-gray-500 ">
                        <thead className="text-xs rounded-full border bg-white text-gray-700 uppercase">
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr className="border rounded-full bg-white my-8 ">
