...
const Topbar = ({ setOpenToggle, openToggle }) => {
  ...
  useEffect(() => {
    if (mode != null) {
      localStorage.setItem("ModeOfDaseboard", JSON.stringify({ mode }));
      themeChanger(mode)
    }
  }, [mode]);
  ...
  useEffect(() => {
    const modeGet = () => {
      const modeStatus = JSON.parse(localStorage.getItem("ModeOfDaseboard"));
      themeChanger(modeStatus.mode);
  ...
  return (
    <>
      ...
      >
        <div className="flex">
          <a className="btn bg-transparent border-none shadow-none hover:bg-transparent text-xl dark:text-white">
              ...
              <li>
                <div className="dropdown dropdown-hover ">
                  ...
                  >
                    ...
                    <div
                      tabIndex={0}
                      className={`dropdown-content z-[1] menu  shadow bg-base-100 rounded w-72 mt-7  ${openToggle ? "-right-1" :"-right-9"}  `}
                    >
                      <div className=" flex gap-4 bg-gray-100 rounded-md justify-center  py-1 items-center">
                        <div>
